...
const footer = () => {
  return (
    <div>
        <footer className={`${styles.footerContainer} footer bg-customBg  text-base-content p-10`}>
            <nav>
            ...
            <nav>
                ...
                <a href='#skills' className="link link-hover">Services</a>
            ...
            <footer className="footer bg-customBg border-gray-400 border-t px-10 py-4">
            <aside className="grid-flow-col items-center">
                ...
                <p>
                © 2024 Ejhay Gofredo - All rights reserved
                <br />
